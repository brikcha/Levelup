...
export const STOCK_CREATE_REVIEW_REQUEST =
  "STOCK_CREATE_REVIEW_REQUEST";
export const STOCK_CREATE_REVIEW_SUCCESS =
  "STOCK_CREATE_REVIEW_SUCCESS";
export const STOCK_CREATE_REVIEW_FAIL =
  "STOCK_CREATE_REVIEW_FAIL";
export const STOCK_CREATE_REVIEW_RESET =
  "STOCK_CREATE_REVIEW_RESET";
export const STOCK_LIST_MY_REQUEST = "STOCK_LIST_MY_REQUEST";
export const STOCK_LIST_MY_SUCCESS = "STOCK_LIST_MY_SUCCESS";
export const STOCK_LIST_MY_RESET = "STOCK_LIST_MY_RESET";
export const STOCK_LIST_MY_FAIL = "STOCK_LIST_MY_FAIL";
